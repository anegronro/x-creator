...
SEMILLAS: tuple[Semilla, ...] = (
    ...
    Semilla("orar", "praying for someone who will never know",
            "Who did you pray for this week?", finde=True),
    Semilla("domingo", "the one day you let the week stop",
            "What does a real day off look like for you?", finde=True),
    Semilla("padres", "time with your parents while you still have it",
            "What do you still want to ask them?", finde=True),
    Semilla("primer_trabajo", "the first job that taught you to show up",
            "What did your first job teach you that school didn't?",
            finde=True),
    Semilla("vecinos", "the neighbor who shows up before anyone else",
            "Who shows up for you without being asked?", finde=True),
    Semilla("miedo", "doing it while still a little scared",
            "What did you do scared and never regret?", finde=True),
    Semilla("reirse", "laughing at yourself on purpose",
            "When did laughing at yourself save the day?", finde=True),
    Semilla("escuchar", "talking less and hearing more",
            "What did you learn by just letting someone finish?",
            finde=True),
    Semilla("mentores", "the person who told you the hard thing early",
            "Who told you the truth before you were ready?", finde=True),
    Semilla("libros", "one book that rearranged how you think",
            "Which book still changes how you act?", finde=True),
    Semilla("caminar", "a walk outside beating any productivity hack",
            "Where do your best ideas actually show up?", finde=True),
    Semilla("playa", "living somewhere the ocean is ten minutes away",
            "What does the ocean fix that nothing else does?", finde=True),
    Semilla("comida", "a table full of people and no phones",
            "What meal would you repeat every week if you could?",
            finde=True),
    Semilla("musica", "the song that resets your whole mood",
            "What are you playing when you need to reset?", finde=True),
    Semilla("empezar_lunes", "wanting Monday instead of dreading it",
            "What would make you want Monday?", finde=True),
    Semilla("disciplina", "keeping a small promise to yourself",
            "What tiny promise do you keep no matter what?", finde=True),
    Semilla("ayudar_joven", "helping someone younger skip a mistake",
            "What would you tell the version of you from five years ago?",
            finde=True),
    Semilla("gracias_salud", "thanking God for a body that still works",
            "What do you take for granted until it hurts?", finde=True),
    Semilla("decir_no", "the peace of a clean no",
            "What did saying no protect?", finde=True),
    Semilla("pequenos_logros", "celebrating the small win out loud",
            "What small thing went right this week?", finde=True),
    Semilla("trabajo_honesto", "honest work with nothing to hide",
            "What would you do the same way if everyone could see it?",
            finde=True),
    Semilla("paciencia_propia", "being patient with yourself",
            "What are you still learning slower than you'd like?",
            finde=True),
    Semilla("barrio", "where you grew up shaping how you work",
            "What did your block teach you about people?", finde=True),
    Semilla("suerte", "naming the luck instead of calling it all skill",
            "Where were you lucky and nearly called it talent?",
            finde=True),
    ...
    Semilla("cansancio", "being tired for the right reasons",
            "What kind of tired feels good?", finde=True),
    Semilla("amigos_viejos", "friends from before anything worked out",
            "Who knew you before any of this?", finde=True),
    Semilla("fe_dudas", "keeping faith through the parts you don't get",
            "What do you hold on to when you don't understand?",
            finde=True),
    Semilla("servicio_iglesia", "showing up to serve when nobody is counting",
            "Where do you help when there is no scoreboard?", finde=True),
    Semilla("perspectiva", "the problem that looked huge and wasn't",
            "What looked like the end of the world a year ago?",
            finde=True),
)
